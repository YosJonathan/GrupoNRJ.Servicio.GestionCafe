// <copyright file="CafeRobustaOscuro.cs" company="GrupoAnalisis">
...
namespace GrupoNRJ.Servicio.GestionCafe.Factory
{
    ...
    /// <summary>
    /// Clase para cafe robusta de tipo oscuro.
    /// </summary>
    public class CafeRobustaOscuro : ICafe
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CafeRobustaOscuro"/> class.
        /// </summary>
        /// <param name="configuration">Objeto de configuración.</param>
        public CafeRobustaOscuro(IConfiguration configuration)
        {
        ...
        public RespuestaBase<bool> CreaLote(decimal cantidad)
        {
            ...
            RespuestaBase<bool> respuesta = gestor.CrearLote(cantidad, "ROBUSTA", "OSCURO");
            return respuesta;
        }
    }
}
